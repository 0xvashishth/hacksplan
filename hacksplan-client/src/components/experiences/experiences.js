...
export default function Experiences() {
  ...
  return (
    <>
      ...
      <div className="mt-9 m-4 grid mb-8 shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-2 lg:grid-cols-3">
        {Experience.experience.map((e, key) => {
          var link = "/experiences/exp?id=" + key;
          return (
            <a
              href={link}
              className="flex m-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white flex-col items-center justify-center p-8 text-center bg-white border border-gray-200 rounded md:rounded dark:bg-gray-800 dark:border-gray-700"
            >
              <blockquote className="max-w-1xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
        ...
        {/* <a
          href="/experiences/1"
          className="flex m-4 flex-col items-center justify-center p-8 text-center bg-white border border-gray-200 rounded md:rounded dark:bg-gray-800 dark:border-gray-700"
        >
