      ...
      <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-gray-800">
        <div className="container flex flex-wrap items-center justify-between mx-auto">
          <a href="/" className="flex items-center">
            <img src="/logo-only-clean.png" className="h-6 mr-3 sm:h-9" alt="HacksPlan Logo" />
          ...
          <div className="flex md:order-2">
            ...
            <a
              href="#login"
              className="flex border text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 mr-1 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
          ...
          <div className="flex items-center md:order-2">
            ...
            <button
              type="button"
              className="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-15 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
              id="user-menu-button"
              aria-expanded="false"
            ...
            >
              ...
              <img className="w-8 h-8 rounded-full" src="/logo-only-clean.png" alt="user" />
            </button>
            <div
