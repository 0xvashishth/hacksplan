...
export default function OnGoing(){
    ...
    return(
        <>
        <h2 className="pt-4 dark:bg-gray-800 text-center text-2xl font-extrabold text-gray-400 md:text-3xl lg:text-3xl">
          ...
          return (
            <div className="max-w-sm m-3 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              <a href="#link">
                <img
